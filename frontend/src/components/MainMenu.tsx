      ...
      <header className="text-center mb-8 z-10 flex flex-col items-center">
        ...
        <div className="w-16 h-16 mb-4 relative group">
          ...
          <svg className="w-full h-full relative z-10 drop-shadow-[0_4px_12px_rgba(16,185,129,0.25)] group-hover:scale-105 transition-transform duration-500" viewBox="0 0 100 100" fill="none">
            ...
            <circle cx="50" cy="50" r="46" fill="url(#logoBgGrad)" stroke="url(#logoBorderGrad)" strokeWidth="2" />
            
            <circle cx="50" cy="50" r="41" stroke="#10b981" strokeWidth="0.5" strokeDasharray="3 6" opacity="0.3" />

            <rect x="48.5" y="24" width="3" height="54" rx="1.5" fill="url(#logoSpineGrad)" opacity="0.9" />

            <path d="M 23 35 C 23 18, 77 18, 77 35" stroke="url(#logoTriloGrad)" strokeWidth="6.5" strokeLinecap="round" />

            <path d="M 21 44 Q 50 30 79 44" stroke="url(#logoTriloGrad)" strokeWidth="4.5" strokeLinecap="round" />
            <path d="M 23 53 Q 50 39 77 53" stroke="url(#logoTriloGrad)" strokeWidth="4.5" strokeLinecap="round" />
            <path d="M 27 62 Q 50 49 73 62" stroke="url(#logoTriloGrad)" strokeWidth="4.5" strokeLinecap="round" />
            <path d="M 33 71 Q 50 59 67 71" stroke="url(#logoTriloGrad)" strokeWidth="4.5" strokeLinecap="round" />

            <path d="M 41 79 Q 50 70 59 79" stroke="url(#logoTriloGrad)" strokeWidth="4.5" strokeLinecap="round" />
